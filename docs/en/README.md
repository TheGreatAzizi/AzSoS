# AZSOS documentation index

> Language: **English** | [فارسی](../fa/README.md)


This folder contains the English version of the GitHub documentation. Every page links to the Persian version at the top.
...
- [AZSOS package format](FORMAT.md)
- [Security model](SECURITY.md)
- [Release checklist](RELEASE.md)
- [Project links](LINKS.md)
- [In-app manual](IN_APP_MANUAL.md)

## Repository language files

- [Root README in English](../../README_EN.md)
- [Root README in Persian](../../README_FA.md)
